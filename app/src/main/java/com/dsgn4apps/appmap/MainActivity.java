...
import com.dsgn4apps.helpers.AdvertHelper;
import com.dsgn4apps.helpers.AnalyticsHelper;
import com.dsgn4apps.helpers.BillingHelper;

import java.util.ArrayList;
import java.util.List;

import static com.dsgn4apps.appmap.Configurations.PUBLIC_KEY;
import static com.dsgn4apps.appmap.Configurations.TEST_DEVICES;
...
public class MainActivity extends AppCompatActivity implements IabBroadcastReceiver.IabBroadcastListener {
    ...
    final int NAV_HOME = 0, NAV_BOOKMARKED = 1,NAV_DEPARTMENT = 2, NAV_MORE = 3, NAV_INFO = 4, NAV_PREMIUM = 5, NAVSETTINGS = 6, NAV_NEWS = 7, NAV_PROFILE = 8, NAV_LOGOUT = 9, NAV_MUNICIPALITIES = 10, NAV_CATEGORIES = 100;
...
//        getResources().updateConfiguration(configuration, getResources().getDisplayMetrics());
                    ...
                    public boolean onItemClick(View view, int position, IDrawerItem drawerItem) {
                        ...
                        switch ((int) drawerItem.getIdentifier()) {
                            ...
                            case NAV_BOOKMARKED:
                                ...
                                break;
                            case NAV_DEPARTMENT:
                                changeFragment(new DepartmentFragment());
                                break;
                            case NAV_MUNICIPALITIES:
                                changeFragment(new MunicipalitiesFragment());
                                break;
                            case NAV_INFO:
    ...
    public IDrawerItem[] getDrawerItems(List<Category> categories) {
        ...
        drawerItems.add(new PrimaryDrawerItem().withIdentifier(NAV_DEPARTMENT).withName(R.string.nav_department).withIcon(FontAwesome.Icon.faw_bars));
        drawerItems.add(new PrimaryDrawerItem().withIdentifier(NAV_MUNICIPALITIES).withName(R.string.nav_municipalities).withIcon(FontAwesome.Icon.faw_bars));
