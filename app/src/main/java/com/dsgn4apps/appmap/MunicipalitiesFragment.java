...
public class MunicipalitiesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        webview.setWebChromeClient(new WebChromeClient() {
            public void onProgressChanged(WebView view, int progress) {
                ...
                Toast.makeText(activity, "Si tienes problema visualizando el mapa ingresa a: http://www.dsgn4apps.com/mcpmaps/" , Toast.LENGTH_SHORT).show();
            }
        });
        ...
        webview.loadUrl("http://www.dsgn4apps.com/mcpmaps/");
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        context = getActivity();
        getActivity().setTitle(getString(R.string.municipalities_page_title));
